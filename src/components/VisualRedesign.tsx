...
const VisualRedesign = () => {
  ...
  return (
    <main className="redesign-page">
      ...
      <section className="stories-section"><div className="container stories-layout"><div><span className="section-kicker">PROVA SOCIAL</span><h2>Histórias reais, com contexto.</h2><p>O espaço está preparado para receber depoimentos reais, com cargo, empresa e autorização de uso — sem retratos genéricos ou promessas inventadas.</p><div className="stories-note"><Quote size={18} /><span>Depoimentos validados entram nesta faixa após aprovação do conteúdo.</span></div></div><div className="story-placeholder"><div className="placeholder-top"><span className="placeholder-line short" /><span className="placeholder-dot" /></div><div className="placeholder-quote">“A evolução começa quando dados e desenvolvimento passam a conversar.”</div><div className="placeholder-bottom"><span>Formato visual preparado</span><span>Swipe no mobile</span></div></div></div></section>
