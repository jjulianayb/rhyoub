    ...
    <section ref={ref} className="section-padding">
      <div className="container mx-auto max-w-4xl text-center">
        ...
        >
          ...
          <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-balance text-foreground mb-8">
            Nossa Resposta
          </h2>
          ...
          <button
            ...
            className="group inline-flex items-center gap-3 border-2 border-primary text-primary px-8 py-4 rounded-xl text-lg font-semibold transition-all duration-300 hover:bg-primary hover:text-primary-foreground hover:shadow-lg hover:shadow-primary/20"
          >
            Descubra como
